...
function TransactionManagement() {
  ...
  const handleGetAiFeedback = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!aiPrompt.trim()) {
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {!loading && accounts.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-gray-800">AI Advisor</h3>
                <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <p className="text-gray-600 mb-4">Get AI-powered financial insights</p>
              <button
                onClick={openAiFeedbackModal}
            ...
            <form onSubmit={handleGetAiFeedback}>
              <div className="mb-4">
                ...
                <textarea
                  ...
                  placeholder="e.g., How can I reduce my spending on groceries? What are my spending patterns?"
                  rows={4}
                  required
                  disabled={aiLoading}
                />
              ...
              {aiLoading && (
                <div className="mb-4 text-center py-4">
                  ...
                  <p className="text-gray-600 mt-2">AI is analyzing your transactions...</p>
                </div>
              )}
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={() => { setShowAiFeedbackModal(false); setAiPrompt(''); setAiResponse(''); }}
                  className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded font-medium hover:bg-gray-50"
                  disabled={aiLoading}
                >
                  Close
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-blue-600 text-white rounded font-medium hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
                  disabled={aiLoading}
                >
